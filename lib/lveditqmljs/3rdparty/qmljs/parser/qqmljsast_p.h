...
public:
    ...
    UiQualifiedId(const QString &name)
        : next(this), name(name)
    { kind = K; }

    UiQualifiedId(UiQualifiedId *previous, const QString &name)
        : name(name)
    {
        kind = K;
        next = previous->next;
...
public:
    ...
    TemplateLiteral(const QString &str, const QString &raw, ExpressionNode *e)
...
public:
    ...
    RegExpLiteral(const QString &p, int f):
...
public:
    ...
    PatternElement(const QString &n, TypeAnnotation *typeAnnotation = nullptr, ExpressionNode *i = nullptr, Type t = Binding)
...
public:
    ...
    PatternProperty(PropertyName *name, const QString &n, ExpressionNode *i = nullptr)
...
public:
    ...
    IdentifierPropertyName(const QString &n):
        id (n) { kind = K; }

    void accept0(Visitor *visitor) override;

    QString asString() const override { return id; }
...
public:
    ...
    StringLiteralPropertyName(const QString &n):
        id (n) { kind = K; }
...
public:
    ...
    FieldMemberExpression(ExpressionNode *b, const QString &n):
        base (b), name (n)
        { kind = K; }
...
public:
    ...
    ContinueStatement(const QString &l = QString()):
        label (l) { kind = K; }
...
public:
    ...
    BreakStatement(const QString &l):
        label (l) { kind = K; }
...
public:
    ...
    LabelledStatement(const QString &l, Statement *stmt):
...
public:
    ...
    FunctionExpression(const QString &n, FormalParameterList *f, StatementList *b, TypeAnnotation *typeAnnotation = nullptr):
...
public:
    ...
    FunctionDeclaration(const QString &n, FormalParameterList *f, StatementList *b, TypeAnnotation *typeAnnotation = nullptr):
...
public:
    ...
    ClassExpression(const QString &n, ExpressionNode *heritage, ClassElementList *elements)
...
public:
    ...
    ClassDeclaration(const QString &n, ExpressionNode *heritage, ClassElementList *elements)
...
public:
    ...
    ImportSpecifier(const QString &importedBinding)
        : importedBinding(importedBinding)
    {
        kind = K;
    }

    ImportSpecifier(const QString &identifier, const QString &importedBinding)
...
public:
    ...
    NameSpaceImport(const QString &importedBinding)
        : importedBinding(importedBinding)
    {
        kind = K;
    }
...
public:
    ...
    ImportClause(const QString &importedDefaultBinding)
    ...
    ImportClause(const QString &importedDefaultBinding, NameSpaceImport *nameSpaceImport)
        : importedDefaultBinding(importedDefaultBinding)
        , nameSpaceImport(nameSpaceImport)
    {
        kind = K;
    ...
    ImportClause(const QString &importedDefaultBinding, NamedImports *namedImports)
        : importedDefaultBinding(importedDefaultBinding)
        , namedImports(namedImports)
    {
        kind = K;
...
// attributes
    ...
    QString importedDefaultBinding;
...
public:
    ...
    FromClause(const QString &moduleSpecifier)
...
public:
    ...
    ImportDeclaration(const QString &moduleSpecifier)
        : moduleSpecifier(moduleSpecifier)
    {
        kind = K;
    }
...
public:
    ...
    ExportSpecifier(const QString &identifier)
        : identifier(identifier), exportedIdentifier(identifier)
    {
        kind = K;
    }

    ExportSpecifier(const QString &identifier, const QString &exportedIdentifier)
...
public:
    ...
    UiImport(const QString &fileName)
...
public:
    ...
    UiParameterList(UiQualifiedId *t, const QString &n):
        type (t), name (n), next (this)
        { kind = K; }

    UiParameterList(UiParameterList *previous, UiQualifiedId *t, const QString &n):
        type (t), name (n)
    {
        kind = K;
        next = previous->next;
...
public:
    UiEnumMemberList(const QString &member, double v = 0.0)
        : next(this), member(member), value(v)
    { kind = K; }

    UiEnumMemberList(UiEnumMemberList *previous, const QString &member)
        : member(member)
    {
        kind = K;
        next = previous->next;
    ...
    UiEnumMemberList(UiEnumMemberList *previous, const QString &member, double v)
...
public:
    ...
    UiEnumDeclaration(const QString &name,
