...
#ifndef LVTEXTUTIL_P_H
#define LVTEXTUTIL_P_H
...
class TextUtil : public QObject   // For the benefit of translations.
{
    Q_OBJECT
public:
...
void TextUtil::setCursorDelegate(Private *d, QQmlComponent *delegate)
{
...
template <typename Private>
void TextUtil::createCursor(Private *d)
{
    if (!d->cursorPending)
        return;
