...
#ifndef LVTEXTNODEENGINE_P_H
#define LVTEXTNODEENGINE_P_H
...
public:
    ...
    public:
        BinaryTreeNode()
            : selectionState(Unselected), clipNode(nullptr), decorations(TextNode::NoDecoration)
        ...
        BinaryTreeNode(const QRectF &brect, const QImage &i, SelectionState selState, qreal a)
            : boundingRect(brect), selectionState(selState), clipNode(0), decorations(TextNode::NoDecoration)
        ...
        BinaryTreeNode(const QGlyphRun &g, SelectionState selState, const QRectF &brect,
                       const TextNode::Decorations &decs, const QColor &c, const QColor &bc,
        ...
        TextNode::Decorations decorations;
        QColor color;
        ...
        static void insert(QVarLengthArray<BinaryTreeNode, 16> *binaryTree, const QGlyphRun &glyphRun, SelectionState selectionState,
                           TextNode::Decorations decorations, const QColor &textColor, const QColor &backgroundColor, const QPointF &position);
    ...
    TextNodeEngine() : m_hasSelection(false), m_hasContents(false) {}
    ...
    void addToSceneGraph(TextNode *parent,
...
private:
    ...
    // This is where all the stuff gets collected?
