 ...
 */
class LV_ELEMENTS_ENGINE_EXPORT Function{
...
public:
    ...
    class LV_ELEMENTS_ENGINE_EXPORT CallInfo{
    ...
    class LV_ELEMENTS_ENGINE_EXPORT Parameters{
...
template<> LV_ELEMENTS_ENGINE_EXPORT bool Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value::Int32 Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value::Int64 Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value::Number Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT std::string Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Callable Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Object Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT ScopedValue Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Element* Function::CallInfo::extractValue(v8::FunctionCallbackInfo<v8::Value> const* info, int index);
...
template<> LV_ELEMENTS_ENGINE_EXPORT bool Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value::Int32 Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value::Int64 Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value::Number Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT std::string Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Callable Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Object Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Value Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT ScopedValue Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
template<> LV_ELEMENTS_ENGINE_EXPORT Element* Function::Parameters::extractValue(Engine* engine, v8::Local<v8::Value> const* args, int index);
