...
public:
    static bool reserveForRead(const QQmlPropertyMap& t, Shared::RefScope* locker, Act* filter);
    static bool reserveForWrite(const QQmlPropertyMap& t, Shared::RefScope* locker, Act* filter);
