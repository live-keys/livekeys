...
public:
    static bool reserveForRead(const QQmlPropertyMap& t, Shared::ReadScope* locker, Act* filter);
    static bool reserveForWrite(const QQmlPropertyMap& t, Shared::ReadScope* locker, Act* filter);
