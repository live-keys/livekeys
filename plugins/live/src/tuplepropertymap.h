...
public:
    static bool reserveForRead(const QQmlPropertyMap& t, Shared::RefScope* locker, QmlAct* filter);
    static bool reserveForWrite(const QQmlPropertyMap& t, Shared::RefScope* locker, QmlAct* filter);
