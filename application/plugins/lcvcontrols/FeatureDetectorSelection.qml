        ...
        QtObject{
            ...
            property list<Component> configurationFields : [
                Component{
                    ConfigurationField{
                        label : "Threshold"
                        editor : InputBox{text: root.configuration["FastFeatureDetector"]["threshold"]; onTextChanged: root.configuration["FastFeatureDetector"]["threshold"] = text;}
                    }
                },
                Component{
                    ConfigurationField{
                        label : "Non Max Suppression"
                        editor : InputBox{text: root.configuration["FastFeatureDetector"]["nonmaxSuppresion"]; onTextChanged: root.configuration["FastFeatureDetector"]["nonMaxSuppresion"] = text;}
                    }
                }
            ]
        },
        QtObject{
            ...
            property list<Component> configurationFields : [
                Component{
                    ConfigurationField{
                        label : "Threshold"
                        editor : InputBox{text: root.configuration["BriskFeatureDetector"]["thresh"]; onTextChanged: root.configuration["BriskFeatureDetector"]["thresh"] = text;}
                    }
                },
                Component{
                    ConfigurationField{
                        label : "Octaves"
                        editor : InputBox{text: root.configuration["BriskFeatureDetector"]["octaves"]; onTextChanged: root.configuration["BriskFeatureDetector"]["octaves"] = text;}
                    }
                },
                Component{
                    ConfigurationField{
                        label : "Pattern Scale"
                        editor : InputBox{text: root.configuration["BriskFeatureDetector"]["patternScale"]; onTextChanged: root.configuration["BriskFeatureDetector"]["patternScale"] = text;}
                    }
                }
            ]
        }
