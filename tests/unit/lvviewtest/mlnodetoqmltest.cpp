...
Q_TEST_RUNNER_REGISTER(MLNodeToQmlTest);

using namespace lv;

MLNodeToQmlTest::MLNodeToQmlTest(QObject *parent)
    : QObject(parent)
{
}

MLNodeToQmlTest::~MLNodeToQmlTest(){
}

void MLNodeToQmlTest::initTestCase(){
}

void MLNodeToQmlTest::qmlConvertTest(){
    MLNode n = {
        {"object", {
             {"string", "value1"},
             {"key2", 100}
