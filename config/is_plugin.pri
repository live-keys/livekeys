...
win32:{
    ...
    DLLDESTDIR = $$BUILD_PATH/bin/plugins/$$PLUGIN_NAME
}else:DESTDIR = $$BUILD_PATH/bin/plugins/$$PLUGIN_NAME
...
!exists($$PLUGIN_QML_DIR){
    ...
    qmlcopy.commands = $$deployDirCommand($$PLUGIN_QML_DIR, $$BUILD_PATH/bin/plugins/$$PLUGIN_NAME)
}
