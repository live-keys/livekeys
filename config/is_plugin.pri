...
win32:{
    ...
    DLLDESTDIR = $$BUILD_PWD/bin/plugins/$$PLUGIN_NAME
}else:DESTDIR = $$BUILD_PWD/bin/plugins/$$PLUGIN_NAME
...
!exists($$PLUGIN_QML_DIR){
    ...
    qmlcopy.commands = $$deployDirCommand($$PLUGIN_QML_DIR, $$BUILD_PWD/bin/plugins/$$PLUGIN_NAME)
}
