...
# --- Deploy tree paths ---
# NOTE: DEPLOY_PATH is defined in .qmake.conf to be globally viable
initVar(PATH_DEPLOY_PATH,                 $$DEPLOY_PATH)
initVar(PATH_DEPLOY_APPLICATION,         $$PATH_DEPLOY_PATH)
initVar(PATH_DEPLOY_EDITOR,              $$PATH_DEPLOY_PATH/$$SUBPATH_EDITOR)
initVar(PATH_DEPLOY_EDITOR_LCVEDITOR,    $$PATH_DEPLOY_PATH/$$SUBPATH_EDITOR_LCVEDITOR)
initVar(PATH_DEPLOY_EDITOR_QMLJSPARSER,  $$PATH_DEPLOY_PATH/$$SUBPATH_EDITOR_QMLJSPARSER)
initVar(PATH_DEPLOY_PLUGINS,             $$PATH_DEPLOY_PATH/$$SUBPATH_PLUGINS)
initVar(PATH_DEPLOY_PLUGINS_CORE,        $$PATH_DEPLOY_PATH/$$SUBPATH_PLUGINS_CORE)
initVar(PATH_DEPLOY_PLUGINS_FEATURES2D,  $$PATH_DEPLOY_PATH/$$SUBPATH_PLUGINS_FEATURES2D)
initVar(PATH_DEPLOY_PLUGINS_IMGPROC,     $$PATH_DEPLOY_PATH/$$SUBPATH_PLUGINS_IMGPROC)
initVar(PATH_DEPLOY_PLUGINS_LIVE,        $$PATH_DEPLOY_PATH/$$SUBPATH_PLUGINS_LIVE)
initVar(PATH_DEPLOY_PLUGINS_PHOTO,       $$PATH_DEPLOY_PATH/$$SUBPATH_PLUGINS_PHOTO)
initVar(PATH_DEPLOY_PLUGINS_VIDEO,       $$PATH_DEPLOY_PATH/$$SUBPATH_PLUGINS_VIDEO)
